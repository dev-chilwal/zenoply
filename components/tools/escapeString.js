...
// Everything HTML 4.01 defines outside the Latin-1 block, in code-point order.
// Completing the set matters more than it looks: a document using &rArr; or
// &isin; is not exotic, and a half-table silently passes those through.
// `lang` and `rang` follow HTML5 (U+27E8/U+27E9) rather than HTML 4.01's
// U+2329/U+232A, because that is what every browser resolves them to.
const EXTRA_ENTITIES = {
  ...
  lang: 10216, rang: 10217,
};

export const ENTITY_TO_CP = (() => {
