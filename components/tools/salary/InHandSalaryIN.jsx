"use client";
// India take-home pay — CTC-based, tied to the chosen tax regime.
// Pinned to INR: the maths is Indian statute (PF, gratuity, professional tax,
// old/new regime slabs), so re-denominating it would be meaningless.
...
export default function InHandSalaryIN() {
