...
export const TOOLS = [
  ...
  },
  {
    ...
    desc: "Compress a PDF to an exact size limit — 100KB, 200KB, 500KB or any cap a form demands. Names the target and the quality is found for you, in your browser, nothing uploaded.",
    faqs: [
  ...
  },
  {
    ...
    desc: "Password protect a PDF online for free. Add an AES-256 open password so the file can't be viewed without it, then download the encrypted copy — all in your browser, nothing uploaded.",
    faqs: [
  ...
  },
  {
    ...
    desc: "Resize a photo or signature to the exact pixel size and KB range an exam form demands — SSC, IBPS, SBI, NTA and UPSC presets, or your own. Free and in your browser.",
    faqs: [
  ...
  },
  {
    ...
    desc: "Convert HEIC photos from your iPhone to JPG, PNG or WebP. Drop in a whole batch, keep full resolution, and download — free, in your browser, nothing uploaded.",
    faqs: [
