...
export const TOOLS = [
  ...
  { slug: "remove-line-breaks", category: "text", live: false, title: "Remove Line Breaks", desc: "Strip line breaks and extra spacing from text in one click." },
  ...
  { slug: "base64-encoder", category: "dev", live: false, title: "Base64 Encoder / Decoder", desc: "Encode and decode Base64 strings online." },
  { slug: "url-encoder", category: "dev", live: false, title: "URL Encoder / Decoder", desc: "Percent-encode or decode URLs and query strings." },
  { slug: "uuid-generator", category: "dev", live: false, title: "UUID Generator", desc: "Generate random v4 UUIDs in bulk." },
  { slug: "hash-generator", category: "dev", live: false, title: "Hash Generator", desc: "Create MD5, SHA-1 and SHA-256 hashes from text." },
  ...
  { slug: "epoch-converter", category: "convert", live: false, title: "Unix Timestamp Converter", desc: "Convert Unix epoch timestamps to readable dates and back." },
  ...
  { slug: "mortgage-calculator", category: "finance", live: false, title: "Mortgage Calculator", desc: "Estimate monthly mortgage payments and total interest." },
  { slug: "percentage-calculator", category: "finance", live: false, title: "Percentage Calculator", desc: "Calculate percentages, increases and decreases." },
