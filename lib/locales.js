...
export const REGIONS = {
  IN: { name: "India (₹)", locale: "en-IN", currency: "INR", scale: 1,
        taxName: "GST", taxRates: [0, 3, 5, 12, 18, 28], taxStandard: 18, taxInclusiveDefault: true,
  ...
  GB: { name: "United Kingdom (£)", locale: "en-GB", currency: "GBP", scale: 105,
        ...
        fdCompounding: 12, mortgageCompounding: 12 },
  EU: { name: "Eurozone (€)", locale: "en-IE", currency: "EUR", scale: 90,
        taxName: "VAT", taxRates: [0, 7, 19, 21], taxStandard: 21, taxInclusiveDefault: true,
        fdCompounding: 12, mortgageCompounding: 12 },
